window.onload = () => {
  ...
  button.onclick = async () => {
    ...
    if (Object.values(body).some((value) => value === 0)) {
      displayError(
        "Not all questions are answered. <br> Please answer all questions before submitting.",
      );
      return;
    }
    ...
    try {
      ...
      displayError(
        "An error occurred while processing your request. <br> Please try again later.",
      );
    }
  };
};
